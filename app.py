...
if __name__ == "__main__":
    # Limpiar la base de datos y crear las tablas. La siguiente línea limpia la base de datos y la deja nueva en cada
    # ejecución, en la fase final esta línea debería ser eliminada
